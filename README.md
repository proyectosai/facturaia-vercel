...
- las mutaciones locales de bootstrap/login, perfil, feedback, clientes, facturas, cobros, gastos, presupuestos/albaranes y recordatorios ya actualizan el mirror SQLite con upserts dirigidos, sin resincronizarlo completo en cada cambio
...
- `gastos`, `presupuestos/albaranes` y `firmas` ya leen y persisten primero sobre SQLite cuando el mirror está activo
