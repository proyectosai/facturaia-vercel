...
- aplicar también upserts dirigidos de bootstrap/login, perfil, feedback, clientes, facturas, cobros, presupuestos/albaranes, firmas y recordatorios sobre ese mirror para reducir resincronizados completos
...
- usar ya también repositorios locales separados para perfil, feedback, documentos comerciales y firmas en los flujos principales del modo local
